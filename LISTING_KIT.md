...
## FAQ answers (many sites ask these)
...
## The 12 Sites (claim in this order)
...
### 3. Bing Places — bing.com/places (Microsoft)
...
### 5. Yelp — biz.yelp.com
- Categories: "House Cleaning" + "Property Management". Claim by phone verification.
- Use the long "Stellar" blurb. Ask customers for reviews gently.

### 6. Nextdoor Business — nextdoor.com/business *(hyper-local, great for this)*
- Claim brand page, target neighborhoods: Virginia Beach, Norfolk, Chesapeake.
- Post the "Guest-funded turnover" angle — owners love that.

### 7. Yellow Pages — yellowpages.com
- Free claim → "Hampton Roads". Ignore the upsell calls/emails.

### 8. MapQuest — mapquest.com
- Free listing via partner; seed with your NAP so it pulls from GB.

### 9. Foursquare — foursquare.com → "For Business" *(feeds many apps)*
- Free claim, category "House Cleaning". Cheap + synced broadly.

### 10. BBB — bbb.org
- Claim a free business profile (accreditation is optional/paid — skip).
...
### Bonus (free, does more) — only if you want volume
...
2. Keep NAP identical on everything.
3. Add 3–5 real photos (before/after turnover) everywhere.
4. Re-check Google Business weekly for the first month (leads + questions).